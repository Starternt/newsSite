                    ...
                    <div class="login-form">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="text" name="short_description" placeholder="Краткое описание"
                                   value="<?php echo $news['short_description']; ?>">
                            <p>Описание</p>
                            <textarea name="description" cols="140"
                                      rows="20"><?php echo $news['description']; ?></textarea>
                            <p>Категория</p>
                            <select name="category">
                                <?php if (is_array($categories)): ?>
                                    <?php foreach ($categories as $category): ?>
                                        <option <?php if ($category['id'] == $news['category_id']) {
                            ...
                            <p>Статус</p>
                            <select name="status">
                                <option value="0" <?php if ($news['status'] == 0) echo "selected=\"selected\""; ?>>
                                    Скрыт
                                </option>
                                <option value="1" <?php if ($news['status'] == 1) echo "selected=\"selected\""; ?>>
                                    Отображается
                                </option>
                            </select>
                            <br><br><br>
